fetch('./data/responsibilities.json')
  ...
  .then(responsibilityData => {
    ...
    responsibilityData.forEach(item => {
      ...
      <div class="w-full grid grid-cols-12 bg-white bg-opacity-90 py-4 px-2 shadow-lg mt-5 lg:mt-3 wow animate__fadeInUp" data-wow-duration="1s">
        <p class="pl-2 col-span-10 text-teal-800 font-semibold">${item.description}</p>
